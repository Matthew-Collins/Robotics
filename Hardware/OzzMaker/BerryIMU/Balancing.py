...
##        pygame.display.flip()                                                                   #Show the new image on the TFT
        ...
        if Counter == 100:
                Counter = 0
                print(CFangleY, ACCy, rate_gyr_y, AccYangle, gyroYangle)
        ...
        if CFangleY < -60 or CFangleY > 60:
                ...
                SleepCounter = 0
                BalanceValue = CFangleY
                BalancePoint = 0.5
                
##                if BalanceValue > BalancePoint:
##                        if Calibrating:
##                                Move = 1
##                        else:
##                                Move = 1 # int(-(CFangleY - BalancePoint) * 5)
...
##                                StepperRight.oneStep(Adafruit_MotorHAT.FORWARD,  MoveType)
                ...
                if Calibrating:
                        BalancePoint = BalanceValue   
                        CalibratingCounter += 1
                        print "Calibrating ", CalibratingCounter, BalanceValue
                        if CalibratingCounter == 1:
                                print("Calibrating...")
                        if CalibratingCounter == 125:
                                Calibrating = False
                                print("Calibrated:", BalancePoint)
