...
while True:
        ...
        #        print ("\033[1;31;40m\tGRYX Angle %5.2f  GYRY Angle %5.2f  GYRZ Angle %5.2f" % (gyroXangle,gyroYangle,gyroZangle)),
                ...
                #print (CFangleX,CFangleY,CFangleZ)
        print (CFangleY, AccYangle)      
...
##                if CFangleY > BalancePoint:
##                        if Calibrating:
##                                Move = 1
##                        else:
##                                Move = int((CFangleY - BalancePoint) * 5)
##                        print ("Going Forward", Move)
##                        for step in range(Move):
##                                StepperLeft.oneStep( Adafruit_MotorHAT.FORWARD,  Adafruit_MotorHAT.DOUBLE)
##                                StepperRight.oneStep(Adafruit_MotorHAT.BACKWARD, Adafruit_MotorHAT.DOUBLE)
##
##                if CFangleY < BalancePoint:
##                        if Calibrating:
##                                Move = 1
##                        else:
##                                Move = int(-(CFangleY - BalancePoint) * 5)
##                        print ("Going Backwards", Move)
##                        for step in range(Move):
##                                StepperLeft.oneStep( Adafruit_MotorHAT.BACKWARD, Adafruit_MotorHAT.DOUBLE)
##                                StepperRight.oneStep(Adafruit_MotorHAT.FORWARD,  Adafruit_MotorHAT.DOUBLE)
##
##                if Calibrating:
##                        BalancePoint = CFangleY   
##                        CalibratingCounter += 1
##                        print "Calibrating ", CalibratingCounter
##                        if CalibratingCounter == 125:
##                                Calibrating = False
